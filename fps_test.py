...
canvas = c.Canvas()
thickness = 2
triangle = s.Polygon(s.get_polygon_vertices(3, 20, (32,32)), (255, 0, 0), thickness)
square = s.Polygon(s.get_polygon_vertices(4, 20, (96,32)), (0, 255, 0), thickness)
pentagon = s.Polygon(s.get_polygon_vertices(5, 20, (64,64)), (0, 0, 255), thickness)
hexagon = s.Polygon(s.get_polygon_vertices(6, 20, (32,96)), (255, 255, 0), thickness)
heptagon = s.Polygon(s.get_polygon_vertices(7, 20, (96,96)), (0, 255, 255), thickness)
